...
from . import puii_cmd, get_string, HNDLR, async_searcher


@puii_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@puii_cmd(pattern="url ?(.*)")
async def _(event):
